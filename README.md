...
Eine kleine Windows-Tray-App, die per Webcam misst, **wie oft du blinzelst** – und dich bei konzentrierter Bildschirmarbeit sanft daran erinnert, wenn du es zu selten tust. Zusätzlich überwacht sie auf Wunsch deine **Sitzhaltung** (schiefe Schultern, geneigter Kopf, zu nah am Bildschirm, eingesunken) relativ zu einer selbst aufgenommenen Referenzhaltung und erinnert dich ans **Aufstehen**, wenn du zu lange am Stück sitzt.
...
- **Haltungsüberwachung mit persönlicher Kalibrierung**: Im Hauptfenster einmal gerade hinsetzen und „als gut speichern" klicken – ab dann wird relativ zu *deiner* Referenz gewarnt bei: Schultern ungleich hoch, Kopf geneigt, zu nah am Bildschirm, eingesunken. Alle Toleranzen, Karenzzeit und Warn-Abstand einzeln einstellbar (mit Empfehlungswerten). Grenze der Technik: Die Kamera sieht nur Kopf und Schultern – der untere Rücken bleibt unsichtbar
